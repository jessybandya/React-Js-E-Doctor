  ...
  >
    ...
    <CloseIcon onClick={() => setModalShowAbout(false)} fontSize="medium" style={{cursor:'pointer'}} />
      ...
      <Typography variant="body2" color="text.secondary">
        This is a simple web application that allows users to register and login to their accounts, if you are feeling sick you can type your symptoms and get a diagnosis from the system from there we recommend you to a pharmacy.
    </Typography>
      </Modal.Body>
    </Modal>
